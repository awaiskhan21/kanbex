...
const FormField = (props: { props: FormFieldBaseProps<any>; children: React.ReactNode }) => {
  const { id, className, required, label, labelClassName, errorClassName } = props.props
  ...
  return (
    <div className={className}>
      ...
      {props.children}
      <FieldErrorText className={errorClassName} error={resolveFormFieldError(props.props)} />
    </div>
  )
}
