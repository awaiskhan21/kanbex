...
export const useAbortableEffect = (effect: AbortableFunction, dependencies: Array<any>) => {
...
export const parseOptionId: (options: OptionsType[], id: string | string[]) => string = (
  options,
  id
) => {
...
export const getDimensionOrDash = (value: number | string | null | undefined, unit: string) => {
